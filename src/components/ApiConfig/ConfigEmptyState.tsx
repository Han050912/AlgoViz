  ...
  return (
    <div className="flex flex-col items-center justify-center py-16 px-4 text-center">
      ...
      <div className="flex flex-wrap gap-3 justify-center mb-8">
        {presets.map((p) => (
          <button key={p.label} onClick={() => onPresetSelect(p)} className="flex flex-col items-center p-4 rounded-lg transition-all" style={{ background: theme === 'dark' ? '#1F2937' : '#F3F4F6', border: '1px solid var(--color-border)', cursor: 'pointer', minWidth: 160 }}>
